 ...
 * 
 * Instructions:
 * 1. Open your Google Sheet: https://docs.google.com/spreadsheets/d/1wEINmEoLLmSAlBnNAL796agJfgFz-eNIzFeVmlGNozE/edit?usp=sharing
 ...
 * 6. Set:
 *    - Description: MedFlow Triage Logger & Emailer
...
//                      "<tr style='background-color: #f9f9f9;'><td style='padding: 10px; border: 1px solid #ddd;'><strong>Patient Name</strong></td><td style='padding: 10px; border: 1px solid #ddd;'>" + (data.name || "N/A") + "</td></tr>" +
//                      "<tr><td style='padding: 10px; border: 1px solid #ddd;'><strong>Age</strong></td><td style='padding: 10px; border: 1px solid #ddd;'>" + (data.age || "N/A") + "</td></tr>" +
//                      "<tr style='background-color: #f9f9f9;'><td style='padding: 10px; border: 1px solid #ddd;'><strong>Assigned Ward</strong></td><td style='padding: 10px; border: 1px solid #ddd;'>" + (data.ward ? data.ward.toUpperCase() : "N/A") + "</td></tr>" +
//                      "<tr><td style='padding: 10px; border: 1px solid #ddd;'><strong>Assigned Doctor</strong></td><td style='padding: 10px; border: 1px solid #ddd;'>" + (data.assigned_doctor || "N/A") + "</td></tr>" +
